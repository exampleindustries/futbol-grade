...
export function Nav() {
  ...
  return (
    ...
    >
      ...
      {/* Mobile menu */}
      {mobileOpen && (
        <div className="md:hidden border-t px-6 py-4 space-y-3" style={{ borderColor: 'var(--fg-border)', background: 'var(--fg-surface)' }}>
          <a href="/#/coaches" className="block text-sm font-medium py-2" style={{ color: 'var(--fg-text2)' }}>Coaches</a>
          <a href="/#/clubs" className="block text-sm font-medium py-2" style={{ color: 'var(--fg-text2)' }}>Clubs</a>
          <a href="/#/marketplace" className="block text-sm font-medium py-2" style={{ color: 'var(--fg-text2)' }}>Marketplace</a>
        </div>
      )}
    </nav>
  )
